--average days until next access, 31 days of returns, mobile vs desktop, by project 2016-2018
-- for all countries
SELECT project, access_method, wmf_last_access as last_seen_date, 
...
GROUP BY project, wmf_last_access, access_method;