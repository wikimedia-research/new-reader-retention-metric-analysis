...
ggsave("user_returns_bangladesh_31days_from2016.png", p, path = "figures/Bangladesh", units = "in", dpi = 192, height = 6, width = 10, limitsize = FALSE)
rm(p)
...
ggsave("user_returns_indonesia_31days_from2016.png", p, path = "figures/Indonesia", units = "in", dpi = plot_resolution, height = 6, width = 10, limitsize = FALSE)
rm(p)
